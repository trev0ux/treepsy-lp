  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'preload', href: '/fonts/Zodiak-Regular.otf', as: 'font', type: 'font/otf', crossorigin: 'anonymous' },
        { rel: 'preload', href: '/fonts/Zodiak-Bold.otf', as: 'font', type: 'font/otf', crossorigin: 'anonymous' },
      ]
    }
  },
